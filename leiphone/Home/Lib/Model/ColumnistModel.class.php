<?php
class ColumnistModel extends Model{
    ...
    protected $_validate = array(
        array('author_name','require','用户名不能为空'),
        array('author_name','require','出错啦！帐号名称已经存在！',0,'unique',3),
        array('password','require','密码不能为空'),
        array('repassword','password','两次密码不一致','2','confirm'),
        array('phone','11','手机格式错误','2','length'),
        array('phone','require','出错啦！此手机号已注册！','2','unique',3),
