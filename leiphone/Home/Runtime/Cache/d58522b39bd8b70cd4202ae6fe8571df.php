			...
			<div class="panel-body">
				<form action="__URL__/update" method="post" style="width:60%; ">
					<table class="table table-responsive text-right" >
					 <tr>
		                <td>用户名:</td>
		                <td>
		                	<input type="text" value="<?php echo ($info["author_name"]); ?>" class="form-control" name="author_name"/>
		                </td>
		             </tr>
		       <!--       <tr class="text-center">  
	                ...
	                <tr>
	              	  	<td>邮箱:</td>
	              		<td>
	              			<input type="text" name="email"  value="<?php echo ($_SESSION['email']); ?>" class="form-control" readonly/>
	              		</td>
	                </tr>
	        	    <tr>
	                	<td>微信号:</td>
