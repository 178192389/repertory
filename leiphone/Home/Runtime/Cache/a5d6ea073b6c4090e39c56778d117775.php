		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="mynavbar">
				...
				<!-- 	<li><a href="__APP__/Category/sponsor">业界</a></li>
					...
					<li><a href="__APP__/Category/intelhard">智能硬件</a></li>
					<li><a href="__APP__/Category/zhongqi">开发者</a></li> -->
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Category/index?id=<?php echo ($vo["category_id"]); ?>" id="<?php echo ($vo["category_id"]); ?>"><?php echo ($vo["category_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
