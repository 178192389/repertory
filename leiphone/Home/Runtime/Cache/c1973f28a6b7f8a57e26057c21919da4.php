			...
			<div class="panel-body">
				<table class="nav-justified">
					<tr>
						...
						<td>&nbsp;</td>
						<td><a href="#" data-toggle="modal" data-target="#sendEmail" data-whatever="修改密码验证" class="btn btn-primary">修改密码</a></td>
					</tr>
					<tr>
						...
						<!-- href="__URL__/email" target="_self" -->
						
							<td><?php echo ($_SESSION['email']); ?></td>
							<td><a data-toggle="modal" data-target="#sendEmail" data-whatever="更改邮箱验证 " data-email="<input type='hidden' name='text' value='email'/>"  class="btn btn-danger">更换邮箱</a></td>
